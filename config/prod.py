...
JIRA_PROJECT_REQUEST_TYPE_LOOKUP = {
    ...
    JIRA_PROJECT_REQUEST_TYPES[3]: 40,
    JIRA_PROJECT_REQUEST_TYPES[4]: 123,
    JIRA_PROJECT_REQUEST_TYPES[5]: 106
}
...
JIRA_CATEGORY_PROJECT_ROUTE_DICT = {
    ...
    'Sentinel': (JIRA_PROJECTS[4], JIRA_PROJECT_REQUEST_TYPES[4]),
    'Chase': (JIRA_PROJECTS[5], JIRA_PROJECT_REQUEST_TYPES[5]),

    'Research Concierge Services'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Translational Research Ethics Consults (T-RECS)'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Electronic Data Capture'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Medical Record Data Pull'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Informatics Tools'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Community Studios'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Community Seed Grants'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Find Community Research Collaborators'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Find Team Science Research Collaborators'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Team Science Seed Grant'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Researcher Studios'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Biostats, Epidemiology, and Research Design'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'General Regulatory Support'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Recruitment Enhancement'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Multi-Center Study Management'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'Investigator Initiated Trials'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3]),
    'iTHRIV Scholars'.title(): (JIRA_PROJECTS[3], JIRA_PROJECT_REQUEST_TYPES[3])
}
